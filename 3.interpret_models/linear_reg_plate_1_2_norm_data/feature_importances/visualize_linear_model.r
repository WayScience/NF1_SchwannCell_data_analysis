...
input_dir <- "../../1.train_models/linear_reg_plate_1_2_norm_data/data"
lm_file <- file.path(input_dir, "model_properties.tsv")

output_fig_dir <- "figures"
lm_fig <- file.path(output_fig_dir, "combined_plates_lm.png")
